...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    ...
    {
        //Adapter Pattern  var olan bir sistemı kendım sıstemımıze uyarlıyoruz hali hazırdakı mıcrosoft kullanımı bunu geretktırmıyor olabılır ama yarın başka bir sisteme gecerken kodldarımız patlamasın dıye.
        ...
        public void RemoveByPettern(string pattern)   //çalışma anında bellekten silmeye yarıyor reflextion ıle 
        {
